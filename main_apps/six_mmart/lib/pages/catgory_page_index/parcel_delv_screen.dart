...
class ParcelDelvryScreen extends StatefulWidget {
  ParcelDelvryScreen({Key? key, this.title}) : super(key: key);
  final String? title;

  @override
  _ParcelDelvryScreenState createState() => _ParcelDelvryScreenState();
}

class _ParcelDelvryScreenState extends State<ParcelDelvryScreen> {
