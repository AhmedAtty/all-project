...
class ServcesDelvryScreen extends StatefulWidget {
  ServcesDelvryScreen({Key? key, this.title}) : super(key: key);
  final String? title;

  @override
  _ServcesDelvryScreenState createState() => _ServcesDelvryScreenState();
}

class _ServcesDelvryScreenState extends State<ServcesDelvryScreen> {
